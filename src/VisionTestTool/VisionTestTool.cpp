...
// VisionTestTool.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CVisionTestToolApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CVisionTestToolApp 생성

CVisionTestToolApp::CVisionTestToolApp()
{
	// 다시 시작 관리자 지원
...
BOOL CVisionTestToolApp::InitInstance()
{
